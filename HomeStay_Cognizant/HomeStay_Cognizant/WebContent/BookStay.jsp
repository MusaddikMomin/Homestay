...
<body>
	...
	<div class="containerB">
		<div class="container">
			...
			<form>
				<h2>Please Fill the Details below to Book Your Stay</h2>
				<br /> <label>Select Home Stay:</label></b><br /> <select
					...
					placeholder="Enter Room No" name="roomNo" required><br />
				<br /> <label>Check-In:</label></b><br />
				<br /> <input type="date" placeholder="Enter Check In"
					name="checkIn" required><br />
				<br /> <label>Check-Out:</label></b><br />
				<br /> <input type="date" placeholder="Enter Check Out"
					name="checkOut" required><br />
