...
<body>
	...
	<div class="containerB">
		...
		<div class="container">
			<h1>Add HomeStay Details</h1>

			<form action="processAddHomeStay.jsp" method="post" align="center">
				<table class="HomeStayTable" align="center">
					...
					<tr>
						<td>HomeStay Name</td>
						<td><input type="text" name="HomeStay_Name" size="20" /></td>
					</tr>
					<tr>
						<td>Address</td>
					...
					<tr>
						...
						<td><input type="text" name="TotalNo_of_rooms" size="20" /></td>
					</tr>
					<tr>
						<td>Available Facilities</td>
						<td><input type="text" name="Available_facilities" size="20" /></td>
					</tr>
					<tr>
						<td>Date of Availability</td>
						<td><input type="date" name="Date_Available" size="20" /></td>
					</tr>
				</table>
