		...
		%>
				<tr>
					...
					<td><button class="actionBtn"
							onclick="location.href = 'processDeleteHelp.jsp?RequestId=<%=h.getRequestId()%>';">Delete</button></td>
				</tr>
...
%>
			...
			<button class="actionBtn" onclick="location.href = 'Help.jsp';">Help</button>
		</div>
	</div>
