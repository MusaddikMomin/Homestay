		...
		%>
				<tr>
					...
					<td><button class="actionBtn"
							onclick="location.href = 'editTour.jsp?HomeStay_Name=<%=t.getHomeStay_Name()%>';">Edit</button></td>
					<td><button class="actionBtn"
							onclick="location.href = 'processDeleteTour.jsp?HomeStay_Name=<%=t.getHomeStay_Name()%>';">Delete</button></td>
				</tr>
...
%>
			...
			<button class="actionBtn" onclick="location.href = 'AddTour.jsp';">Add
				Tour Package</button>
		</div>
	</div>
